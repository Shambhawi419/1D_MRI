"""
Training script for the weight-sharing-only ablation (see model.py's
module docstring). Same checkpointing/resume/pretraining/smoothed-best
behavior as ../odls/train.py and ../odls_v2/train.py -- the only
functional difference is the model class (ODLSAblationSharing).
"""
...
def build_argparser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Train the weight-sharing-only ablation")
...
def run_epoch(model: ODLSAblationSharing, loader: DataLoader, criterion: ODLSLoss,
